  ...
  return (
    <div>
        ...
        <div className='profiles-information'>
            ...
            DELIVERABLES.map((deliverable)=><Panel.Container><DeliverablePanel key={deliverable.DeliverableID} deliverable = {deliverable} categories={categories} reloadDeliverables={()=>loadDeliverables('/deliverables')}/></Panel.Container>)}
        </div>
        </div>
    </div>
  )
