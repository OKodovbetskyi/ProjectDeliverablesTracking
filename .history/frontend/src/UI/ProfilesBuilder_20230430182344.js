...
const ProfilesBuilder = () => {
  ...
  const clickHandler= async (devID) =>{
    const assingDeliverableToProfileObject = {AssignmentProfDevDevID: devID, AssignmentProfDevProfID: state.id}
    const response = await API.post("/profiles/deliverables" , assingDeliverableToProfileObject);
