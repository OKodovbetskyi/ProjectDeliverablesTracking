...
const DeliverablePanel = ({deliverable ,categories,reloadDeliverables, assign}) => {
...
assign && 
<ToolTipDecorator message='Delete deliverable'>
<ActionAdd showText onClick={()=>handleDelete(deliverable.DeliverableID)} buttonText="Assign" />
</ToolTipDecorator>
}
</ActionTray>
