...
const DeliverablePanel = ({deliverable ,categories,reloadDeliverables, assign, studentID}) => {
    ...
    const handleAssign = async ()=>{
      const object = {
        AssignmentDevDevID: deliverable.DeliverableID,
        AssignmentDevUserID: studentID
      }
